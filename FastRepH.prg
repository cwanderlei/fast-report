...
CLASS frReportManager
   Hidden:
     VAR _InitSyst, _FrNotifyError, _CloseSyst, _SetIcon, _SetTitle, _SetVisualActions,;
          ...
          _LoadFromFile, _LoadFromBlob, _SaveToFile, _SaveToBlob, _Clear, _LoadStyleSheet, _Print, _GetErrors,;
          ...
          _LineAt, _PictureAt, _SendMail, _frMsgBox
...
METHOD SetIcon(nNumber) class frReportManager
RETURN Call_Func_I_I(::_SetIcon, nNumber) == 1
...
PRIVATE tmp_ParamB,tmp_ParamA  
   IF nAction == 3 //FR_ACT_USER   - Kleyber Derick - 31/01/2008 - 11:46:01
...
//                  available in the report. OnUserFunction-eventhandler 
//                  must be assigned. 
...
RETURN Call_Func_CIII_I(::_SetWorkArea, cFrAlias, nWorkArea, lOem, aRangeParams) == 1
